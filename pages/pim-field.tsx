        ...
        >
            ...
            <Box style={{
                ...
                {bike.image ? (
                    ...
                    <svg fill="#6c757d" height="40px" width="40px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300.25 300.25" style={{ opacity: 0.5 }}>
            ...
            {/* Bike Information */}
            <Box style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '2px' }}>
                <Box style={{
                    fontSize: '13px',
                    fontWeight: '500',
                    color: '#495057',
